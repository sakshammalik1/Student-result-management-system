...
class Result:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Add Student Results",font=("goudy old style",20,"bold"),bg="orange",fg="#262626").place(x=10,y=15,width=1120,height=50)
...
#---------------------------------------VARIABLES------------------------------------------
        ...
        lbl_select=Label(self.root,text="Select Students",font=("goudy old style",20,"bold"),bg="white").place(x=50,y=100)
        ...
        self.txt_student=ttk.Combobox(self.root,textvariable=self.var_roll,font=("goudy old style",15,"bold"),values=self.roll_list,state="readonly",justify=CENTER)
        self.txt_student.place(x=280,y=100,width=180)
        self.txt_student.set("Select")

        btn_search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),fg="white",cursor="hand2",bg="#03a9f4",command=self.search).place(x=480,y=100,width=100,height=28)
